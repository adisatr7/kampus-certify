  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        valid:
          "border-transparent bg-status-valid text-white hover:bg-status-valid/80",
        invalid:
          "border-transparent bg-status-invalid text-white hover:bg-status-invalid/80",
        revoked:
          "border-transparent bg-status-revoked text-white hover:bg-status-revoked/80",
        pending:
...
export interface StatusBadgeProps
  ...
  status?: 'valid' | 'invalid' | 'revoked' | 'pending';
}
